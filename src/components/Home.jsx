...
<div className="pg1 h-full   w-full  bg-[url(https://www.shutterstock.com/image-photo/data-science-business-analytics-intelligence-600nw-2198469599.jpg)] bg-cover bg-center bg-norepeat flex ">
  ...
  <p className='h-36 w-full  text-base px-4 py-2 text-center'> These days, you can get data about any aspect of your business, ranging from market conditions to consumer values. But without the right tools, this collection of data can seem overwhelming. Data management systems will help you make sense of your data and draw meaning from your insights. </p>

  <button className='h-10 w-32 border-2 border-solid border-black text-base font-bold rounded mt-4 hover:border-sky-900 hover:text-sky-900'>Explore More</button>
